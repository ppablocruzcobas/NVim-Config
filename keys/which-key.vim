...
let g:which_key_map.w = {
      ...
      \ 'c' : ['<plug>(wiki-code-run)'                            , 'run'],
      \ 'b' : ['<plug>(wiki-graph-find-backlinks)'                , 'find'],
      \ 'g' : ['<plug>(wiki-graph-in)'                            , 'in'],
      \ 'G' : ['<plug>(wiki-graph-out)'                           , 'out'],
      \ 'l' : ['<plug>(wiki-link-toggle)'                         , 'toggle'],
      \ 'd' : ['<plug>(wiki-page-delete)'                         , 'delete'],
      \ 'r' : ['<plug>(wiki-page-rename)'                         , 'rename'],
      \ 't' : ['<plug>(wiki-page-toc)'                            , 'toc (glob)'],
      \ 'T' : ['<plug>(wiki-page-toc-local)'                      , 'toc'],
      \ 'e' : ['<plug>(wiki-export)'                              , 'export'],
      \ 'u' : ['<plug>(wiki-list-uniq)'                           , 'list (glob)'],
      \ 'U' : ['<plug>(wiki-list-uniq-local)'                     , 'list'],
      \ }
