...
source $HOME/.config/nvim/keys/abbreviations.vim
source $HOME/.config/nvim/keys/mappings.vim
source $HOME/.config/nvim/keys/which-key.vim

source $HOME/.config/nvim/cfg-plug/floaterm.vim
source $HOME/.config/nvim/cfg-plug/fzf.vim
source $HOME/.config/nvim/cfg-plug/coc.vim
